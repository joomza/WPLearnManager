                            ...
                            <div class="jslm_left_img_wrp">
                                ...
                                <div class="overlay">
                                    <div class="jslm_links">
                                        ...
                                        <span class="jslm_link_icon">
                                            <a title="<?php echo esc_attr(__("Delete Course","learn-manager")); ?>" href="<?php echo esc_url(wp_nonce_url(jslearnmanager::makeUrl(array('jslmsmod'=>'student', 'action'=>'jslmstask', 'task'=>'removeenrollment', 'jslearnmanagerid'=>$row->course_id, 'jslearnmanagerpageid'=>jslearnmanager::getPageid())),'remove-enrollment')); ?>" onclick="return confirm('<?php echo __('Are you sure to delete this course?','learn-manager').'. '.__('Will not longer accessable.','learn-manager').'?'; ?>');"><i class="fa fa-trash"></i></a>
                                        </span>
                                    </div>
